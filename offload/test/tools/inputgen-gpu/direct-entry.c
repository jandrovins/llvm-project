...
// RUN: %inputgen-gpu generate %t.image --device-id=0 --num-teams=1 --num-threads=1 --objects-per-thread=2 | FileCheck --check-prefix=GENERATE %S/direct-entry-reduction.h
